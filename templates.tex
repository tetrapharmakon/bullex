...
\newcommand{\memo}{\ding{117}}%
\newcommand{\up}{\ding{249}}
\newcommand{\down}{\ding{247}}
...
\begin{tikzpicture}[yscale=-1]
  \fill[gray!15] (0,0) rectangle (\WW/4,.75\HH) node[gray!40,pos=.5] {\rotatebox{90}{\fontsize{45}{45}\selectfont \month}};
...
\foreach \n in {1,...,10}{
  \begin{tikzpicture}[yscale=-1]
    ...
    \foreach \i in {1,...,16}{
      \foreach \j in {1,...,24}
      \fill[gray!40] (\i * \Xspacin , \j * \Xspacin) circle (.5pt);
      }
    \draw[line width=.1pt] (0,0) rectangle (\WW,\HH);
  \end{tikzpicture}
