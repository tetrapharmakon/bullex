...
\begin{tikzpicture}[yscale=-1]
  ...
  \draw[gray!40] (0,\i * \trackerSpace) -- (\WWh,\i * \trackerSpace) 
...
\begin{tikzpicture}[yscale=-1]
  \fill[gray!15] (0,0) rectangle (\WW/4,.75\HH) node[gray!40,pos=.5] {\rotatebox{90}{\fontsize{50}{50}\selectfont February}};
